        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <x-inputs.text id="tags" name="tags" label="Tags (comma separated)"
                    placeholder="PHP, Laravel, Remote" :value="old('tags', $job->tags)" />
            </div>
            ...
            <div class="mb-4">
                <x-inputs.text id="zip_code" name="zip_code" label="Zip Code" placeholder="12345" :value="old('zip_code', $job->zip_code)" />
            </div>
            ...
            <div class="mb-4">
                <x-inputs.text id="company_website" name="company_website" type="url" label="Company Website"
                    placeholder="https://www.acme.com" :value="old('company_website', $job->company_website)" />
            </div>
